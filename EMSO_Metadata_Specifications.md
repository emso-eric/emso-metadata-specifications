...
| keywords_vocabulary          | URI of the keywords vocabulary used                                                                                                                                                  | data_type#uri            | false    | false    |
| keyword_type                 | Type of each keyword, indicating its category (e.g. discipline, theme, place, temporal)                                                                                              | data_type#str            | false    | true     |
| keyword_uri                  | URI pointing to the controlled vocabulary term corresponding to each keyword                                                                                                         | data_type#uri            | false    | true     |
...
| project_uri                  | URI pointing to the project description or official project page                                                                                                                     | data_type#uri            | false    | true     |
